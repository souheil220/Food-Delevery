    ...
    final planetThumbnail = new Container(
      ...
      child: new Container(
        ...
        child: new Column(
          ...
          children: <Widget>[
            new Text(order.name, style: MyOrder.planetTitle),
            new Text(order.prix, style: MyOrder.planetLocation),
            new Container(
            ...
            new Row(
              children: <Widget>[
                new Icon(Icons.location_on, size: 14.0,
                  color: Color(0x66FFFFFF)),
                new Text(
                  order.etat, style: MyOrder.planetDistance),
                new Container(width: 24.0),
                new Icon(Icons.flight_land, size: 14.0,
                  color: Color(0x66FFFFFF)),
                new Text(
                  order.prix, style: MyOrder.planetDistance),
              ],
            )
          ],
        ),
